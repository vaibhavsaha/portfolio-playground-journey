...
class Grad implements GradInterface {
  x: number
  y: number
  z: number
...
class Noise implements NoiseInterface {
  grad3: GradInterface[]
  p: number[]
  perm: number[]
  gradP: GradInterface[]
...
export function Waves({
  ...
  const noiseRef = useRef<NoiseInterface>(new Noise(Math.random()))
